...
describe AssaysController do
  ...
  # AssaysController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested assay as @assay" do
      assay = Assay.create! valid_attributes
      get :show, {:id => assay.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested assay as @assay" do
      assay = Assay.create! valid_attributes
      get :edit, {:id => assay.to_param}, valid_session
      assigns(:assay).should eq(assay)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Assay" do
        expect {
          post :create, {:assay => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved assay as @assay" do
        ...
        post :create, {:assay => {}}, valid_session
        assigns(:assay).should be_a_new(Assay)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested assay" do
        ...
        put :update, {:id => assay.to_param, :assay => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested assay as @assay" do
        assay = Assay.create! valid_attributes
        put :update, {:id => assay.to_param, :assay => valid_attributes}, valid_session
        assigns(:assay).should eq(assay)
      end
    ...
    describe "with invalid params" do
      it "assigns the assay as @assay" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Assay.any_instance.stub(:save).and_return(false)
        put :update, {:id => assay.to_param, :assay => {}}, valid_session
        assigns(:assay).should eq(assay)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested assay" do
      assay = Assay.create! valid_attributes
      expect {
        delete :destroy, {:id => assay.to_param}, valid_session
      }.to change(Assay, :count).by(-1)
    end
