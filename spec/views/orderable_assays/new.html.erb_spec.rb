...
describe "orderable_assays/new" do
  before(:each) do
    assign(:orderable_assay, stub_model(OrderableAssay,
  ...
  it "renders new orderable_assay form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => orderable_assays_path, :method => "post" do
