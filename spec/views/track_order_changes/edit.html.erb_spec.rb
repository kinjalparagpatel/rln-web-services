...
describe "track_order_changes/edit" do
  before(:each) do
  ...
  it "renders the edit track_order_change form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => track_order_changes_path(@track_order_change), :method => "post" do
