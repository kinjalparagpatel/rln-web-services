...
describe "orderable_concepts/new" do
  before(:each) do
    assign(:orderable_concept, stub_model(OrderableConcept,
  ...
  it "renders new orderable_concept form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => orderable_concepts_path, :method => "post" do
