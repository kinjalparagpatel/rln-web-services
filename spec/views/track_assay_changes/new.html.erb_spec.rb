...
describe "track_assay_changes/new" do
  before(:each) do
    assign(:track_assay_change, stub_model(TrackAssayChange,
  ...
  it "renders new track_assay_change form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => track_assay_changes_path, :method => "post" do
