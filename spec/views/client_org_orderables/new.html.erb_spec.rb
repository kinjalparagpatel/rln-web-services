...
describe "client_org_orderables/new" do
  before(:each) do
    assign(:client_org_orderable, stub_model(ClientOrgOrderable,
  ...
  it "renders new client_org_orderable form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => client_org_orderables_path, :method => "post" do
