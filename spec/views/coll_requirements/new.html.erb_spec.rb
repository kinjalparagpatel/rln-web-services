...
describe "coll_requirements/new" do
  before(:each) do
    assign(:coll_requirement, stub_model(CollRequirement,
  ...
  it "renders new coll_requirement form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => coll_requirements_path, :method => "post" do
